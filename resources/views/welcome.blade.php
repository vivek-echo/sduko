                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        for (var i = 0; i < postDataLength; i++) {
                            ...
                            var postDataKt = '<div class="col-lg-4 col-md-6 col-12"> <div class="product-list-item"> <div class="product-thumb"> <div class="pro-thumb"> '+hhh+' </div> </div> <div class="product-content"> <h5 class="mb-3"> <a href="javascript:void(0);" data-bs-toggle="modal" onclick="viewPostModal('+res['data'][i]['pId']+')" data-bs-target=".view-Modal"> '+res['data'][i]['postHeading']+' </a> </h5> <h6 class="mb-3"> '+res['data'][i]['modelAge']+' | '+res['data'][i]['typeS']+' | '+res['data'][i]['state']+' | '+res['data'][i]['city']+' </h6> <p class="mb-3">'+res['data'][i]['postDesc']+' </p> <a class="default-btn reverse py-2 px-2 me-2"  href="//api.whatsapp.com/send?phone='+ res['data'][i]['whatsApp']+'" target="_blank"> <span><i class="myicon-whatsapp" ></i> WhatsApp</span>  </a>  </div> </div>  </div>';
